...
const TextareaWithAutosize = React.forwardRef<HTMLTextAreaElement, TextareaAutosizeProps>(({ className, ...props }, ref) => {
...
TextareaWithAutosize.displayName = 'TextareaWithAutosize';
